...
From our output, we can see that `data_values` increase overall from "Poor" to "Good"/ "Very Good" health betwwen 2006 to 2010. However, `data_values` also decrease from "Very Good" to "Excellent".
